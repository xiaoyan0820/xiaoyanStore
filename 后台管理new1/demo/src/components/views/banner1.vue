<template>
    <div>
        ...
        >
            ...
            <el-table-column prop="bannername" label="分类名称"></el-table-column>
            ...
            <el-form :model="bannerInfo" :rules="rules" ref="bannerInfo">
                ...
                >
                    <el-select v-model="bannerInfo.pid" placeholder="请选择">
                        ...
                        <el-option
                            v-for="item in getStateBannerList"
                            :key="item.id"
                ...
                <el-form-item label="分类名称：" :label-width="formLabelWidth" prop="bannername">
                    <el-input v-model="bannerInfo.bannername"></el-input>
                </el-form-item>
